    ...
    <div class="container content-container">
        <div class="columns align-center">
            ...
            <div class="column is-3">
                <form method="get" action="{{ route('search') }}">
                    <div class="control has-icons-right">
                        <input name="q" class="input is-rounded is-small" type="text" placeholder="" value="{{ request('q') }}">
            ...
            <div class="column has-text-primary has-text-right has-text-centered-touch is-2">
                <a href="{{ config('sasmfos.social.linkedin') }}" class="footer-btns">
                    <img src="/images/icons/footer/linkedin.svg" alt="" class="fit-image">
                </a>
                <a href="{{ config('sasmfos.social.twitter') }}" class="footer-btns">
                    <img src="/images/icons/footer/twitter.svg" alt="" class="fit-image">
                </a>
                <a href="{{ config('sasmfos.social.facebook') }}" class="footer-btns">
                    <img src="/images/icons/footer/facebook.svg" alt="" class="fit-image">
                </a>
                <a href="{{ config('sasmfos.social.youtube') }}" class="footer-btns">
