...
@section('content')
    ...
    <page-banner src="{{ asset('images/banners/find-an-mfo-surgeon.jpg') }}" :breadcrumb="['Home']">
        <template v-slot:title>
            Find an <span>MFO Surgeon</span>
        </template>
    </page-banner>

    <floating-image src="{{ asset('images/tools.jpg') }}" alt="Tools" distance="650px"></floating-image>
                ...
                <div class="notice-card">
                    <div class="notice-card-heading">
                        <div class="notice-card-icon">
                            <img src="{{ asset('svg/balance-scale.svg') }}" alt="Balance Scale">
                        </div>
            ...
            <div class="columns">
                <div class="column is-7 is-offset-1">
                    <header class="page-section-header">
                        <div class="icon">
                            <img src="{{ asset('svg/stethascope-hand.svg') }}" alt="Value of using an MFO specialist surgeon">
                        </div>
                    ...
                    <div class="page-section-body">
                        ...
                        <p>
                            ...
                            palate. <a class="has-text-info" href="{{ route('ask') }}#procedures">Click here</a> for a full list of procedures.
                        </p>
        ...
        <section class="page-section" id="directory">
            <div class="columns">
                ...
                <div class="column-4 is-hidden-mobile" style="margin-top: -300px;">
                    <img src="{{ asset('images/kidney-bowl-tools.jpg') }}" alt="Kidney Bowl and Tools">
                </div>
            </div>
        </section>
    </div>
